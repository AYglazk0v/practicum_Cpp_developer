...
public:
    ...
    std::tuple<std::vector<std::string>, DocumentStatus> MatchDocument(ExecutionPolicy&& execut, const std::string& raw_query, int document_id) const {
    ...
    Query<std::set<std::string>> ParseQuery(const std::string& text) const;
    Query<std::vector<std::string>> ParseQueryParallel(const std::string& text) const;
